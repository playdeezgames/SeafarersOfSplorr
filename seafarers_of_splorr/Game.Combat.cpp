...
namespace game::Combat
{
	...
	static CombatResult ResolveMiss()
	{
		...
		if (damage > 0)
		{
			game::avatar::Statistics::SetCauseOfDeath(instance.descriptor.name, instance.descriptor.killedByStatistic, instance.descriptor.deathByAchievement);
	...
	static CombatResult ResolveNoGuess()
	{
		auto instance = game::Creatures::GetInstance(game::Avatar::GetPosition()).value();
		game::avatar::Statistics::SetCauseOfDeath(instance.descriptor.name, instance.descriptor.killedByStatistic, instance.descriptor.deathByAchievement);
		game::avatar::Statistics::Decrease(game::avatar::Statistic::HEALTH, instance.descriptor.attack);
