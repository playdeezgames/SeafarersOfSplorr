...
namespace visuals::WorldMap
{
	...
	static void DrawWall(const std::shared_ptr<common::Application::Renderer>& renderer, const common::XY<int>& plot, const common::XY<size_t>& cell, const maze::Direction& direction)
	{
		auto border = game::world::Borders::GetBorderAhead(cell, direction);
		if (border == game::world::Border::BREAKABLE_WALL || border == game::world::Border::UNBREAKABLE_WALL)
		{
			visuals::Sprites::Draw(wallSprites[direction], renderer, plot, visuals::Colors::Read(visuals::data::Colors::DEFAULT));
		}
	}

	static void DrawLocked(const std::shared_ptr<common::Application::Renderer>& renderer, const common::XY<int>& plot, const common::XY<size_t>& cell, const maze::Direction& direction)
	{
	...
	static void DrawKnownWall(const std::shared_ptr<common::Application::Renderer>& renderer, const common::XY<int>& plot, const common::XY<size_t>& cell, const maze::Direction& direction)
	{
		auto border = game::world::Borders::GetBorderAhead(cell, direction);
		if (border == game::world::Border::BREAKABLE_WALL || border == game::world::Border::UNBREAKABLE_WALL)
		{
	...
	static void DrawKnownLocked(const std::shared_ptr<common::Application::Renderer>& renderer, const common::XY<int>& plot, const common::XY<size_t>& cell, const maze::Direction& direction)
	{
		if (game::world::Borders::GetBorderAhead(cell, direction) == game::world::Border::LOCK)
		{
	...
	static void DrawItem(const std::shared_ptr<common::Application::Renderer>& renderer, const common::XY<int>& plot, const common::XY<size_t>& cell)
	{
	...
	static void DrawDanger(const std::shared_ptr<common::Application::Renderer>& renderer, const common::XY<int>& plot, const common::XY<size_t>& cell)
	{
	...
	static void DrawTrade(const std::shared_ptr<common::Application::Renderer>& renderer, const common::XY<int>& plot, const common::XY<size_t>& cell)
	{
	...
	typedef std::function<void(const std::shared_ptr<common::Application::Renderer>&, const common::XY<int>&, const common::XY<size_t>&, const maze::Direction&)> CellDirectionDrawer;

	static void DrawDirections(const std::shared_ptr<common::Application::Renderer>& renderer, const common::XY<int>& plot, const common::XY<size_t>& cell, const std::vector<CellDirectionDrawer>& cellDirectionDrawers)
	{
	...
	static void DrawAvatar(const std::shared_ptr<common::Application::Renderer>& renderer, const common::XY<int>& plot, const common::XY<size_t>& cell)
	{
	...
	static void DrawVisited(const std::shared_ptr<common::Application::Renderer>& renderer, const common::XY<int>& plot, const common::XY<size_t>& cell)
	{
	...
	static void DrawKnown(const std::shared_ptr<common::Application::Renderer>& renderer, const common::XY<int>& plot, const common::XY<size_t>& cell)
	{
	...
	static void DrawUnknown(const std::shared_ptr<common::Application::Renderer>& renderer, const common::XY<int>& plot, const common::XY<size_t>&)
	{
		visuals::Sprites::Draw(MAP_CELL_UNEXPLORED, renderer, plot, visuals::Colors::Read(visuals::data::Colors::DEFAULT));
	}

	typedef std::function<void(const std::shared_ptr<common::Application::Renderer>&, const common::XY<int>&, const common::XY<size_t>&)> CellDrawer;
	...
	static void DrawInternalWorldMap(const std::shared_ptr<common::Application::Renderer>& renderer, size_t index)
	{
