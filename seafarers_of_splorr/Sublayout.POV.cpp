...
namespace sublayout::POV
{
	...
	const std::map<game::world::Border, std::string> leftSides =
	{
		...
		{game::world::Border::BREAKABLE_WALL, "LeftWall"},
		{game::world::Border::UNBREAKABLE_WALL, "LeftWall"},
		{game::world::Border::BROKEN_WALL, "LeftBroken"}
	};
	...
	const std::map<game::world::Border, std::string> rightSides =
	{
		...
		{game::world::Border::BREAKABLE_WALL, "RightWall"},
		{game::world::Border::UNBREAKABLE_WALL, "RightWall"},
		{game::world::Border::BROKEN_WALL, "RightBroken"}
	};
	...
	const std::map<game::world::Border, std::string> aheads =
	{
		...
		{game::world::Border::BREAKABLE_WALL, "AheadWall"},
		{game::world::Border::UNBREAKABLE_WALL, "AheadWall"},
		{game::world::Border::BROKEN_WALL, "AheadBroken"}
	};
