...
namespace game::characters
{
	...
	{
		data::game::character::EquipmentLegacy::Clear();
	}

	std::optional<Item> Equipment::Read(int characterId, const EquipSlot& equipSlot)
	{
		auto item = data::game::character::EquipmentLegacy::Read(characterId, (int)equipSlot);
		if (item)
		{
	...
	{
		data::game::character::EquipmentLegacy::Write(characterId, (int)equipSlot, (int)item);
	}

	void Equipment::Unequip(int characterId, const EquipSlot& equipSlot)
	{
		data::game::character::EquipmentLegacy::Write(characterId, (int)equipSlot, std::nullopt);
	}
	...
	std::map<EquipSlot, Item> Equipment::All(int characterId)
	{
		return 
			common::utility::Table::Map<int, int, EquipSlot, Item>(
				data::game::character::EquipmentLegacy::All(characterId),
