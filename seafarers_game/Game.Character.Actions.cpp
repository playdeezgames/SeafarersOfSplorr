...
namespace game::character
{
	...
	{
		auto islandId = game::ship::Docked::GetIsland(characterId).value();
	...
	{
		auto data = data::game::island::DarkAlley::Read(game::ship::Docked::GetIsland(characterId).value()).value();
