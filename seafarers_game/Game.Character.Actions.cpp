...
namespace game::character
{
	...
	{
		auto islandId = game::ship::Docked::GetIslandOld(characterId).value();
	...
	{
		auto data = data::game::island::DarkAlley::Read(game::ship::Docked::GetIslandOld(characterId).value()).value();
