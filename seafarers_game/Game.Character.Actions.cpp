...
namespace game::character
{
	...
	{
		auto islandId = game::character::Docked::GetIsland(characterId).value();
	...
	{
		auto data = data::game::island::DarkAlley::Read(game::character::Docked::GetIsland(characterId).value()).value();
