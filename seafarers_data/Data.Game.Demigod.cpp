...
namespace data::game
{
	...
	static const std::string QUERY_ITEM = "SELECT [Name],[PatronWeight],[BlessingThreshold],[BlessingMultiplier],[BlessingPlightId],[CurseThreshold],[CurseMultiplier],[CursePlightId] FROM [Demigods] WHERE [Name]={};";
