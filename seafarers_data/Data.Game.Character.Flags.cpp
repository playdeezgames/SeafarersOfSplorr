...
{
	const static std::string CREATE_TABLE = "CREATE TABLE IF NOT EXISTS [CharacterFlags]([CharacterId] INT NOT NULL,[FlagId] INT NOT NULL, UNIQUE([CharacterId],[FlagId]));";
	const static std::string QUERY_ITEM = "SELECT [FlagId] FROM [CharacterFlags] WHERE [CharacterId]={} AND [FlagId]={};";
	const static std::string REPLACE_ITEM = "REPLACE INTO [CharacterFlags]([CharacterId],[FlagId]) VALUES({},{});";
	const static std::string DELETE_ITEM = "DELETE FROM [CharacterFlags] WHERE [CharacterId]={} AND [FlagId]={};";
	const static std::string QUERY_ALL_FOR_AVATAR = "SELECT [FlagId] FROM [CharacterFlags] WHERE [CharacterId]={};";
