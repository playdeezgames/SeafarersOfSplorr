...
{
	static const std::string CREATE_TABLE = "CREATE TABLE IF NOT EXISTS [IslandMarkets]([IslandId] INT NOT NULL, [CommodityId] INT NOT NULL,[Supply] REAL NOT NULL, [Demand] REAL NOT NULL, [Purchases] REAL NOT NULL, [Sales] REAL NOT NULL, UNIQUE([IslandId],[CommodityId]));";
	static const std::string REPLACE_ITEM = "REPLACE INTO [IslandMarkets]([IslandId],[CommodityId],[Supply],[Demand],[Purchases],[Sales]) VALUES ({},{},{},{},{},{})";
	static const std::string QUERY_ITEM = "SELECT [Supply], [Demand], [Purchases], [Sales] FROM [IslandMarkets] WHERE [IslandId]={} AND [CommodityId]={};";
	static const std::string QUERY_ALL = "SELECT [CommodityId], [Supply], [Demand], [Purchases], [Sales] FROM [IslandMarkets] WHERE [IslandId]={};";
